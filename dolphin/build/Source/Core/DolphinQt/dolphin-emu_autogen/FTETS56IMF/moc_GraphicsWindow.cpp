...
#include "../../../../../../Source/Core/DolphinQt/Config/Graphics/GraphicsWindow.h"
...
QT_MOC_LITERAL(1, 15, 14), // "BackendChanged"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 7) // "backend"

    },
    "GraphicsWindow\0BackendChanged\0\0backend"
};
...
void GraphicsWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GraphicsWindow::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsWindow::BackendChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject GraphicsWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_GraphicsWindow.data,
      qt_meta_data_GraphicsWindow,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void GraphicsWindow::BackendChanged(const QString & _t1)
{
