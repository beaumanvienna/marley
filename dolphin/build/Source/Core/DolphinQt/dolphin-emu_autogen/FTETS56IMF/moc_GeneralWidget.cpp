...
QT_MOC_LITERAL(1, 14, 14), // "BackendChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 7) // "backend"

    },
    "GeneralWidget\0BackendChanged\0\0backend"
};
...
void GeneralWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GeneralWidget *_t = static_cast<GeneralWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (GeneralWidget::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GeneralWidget::BackendChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject GeneralWidget::staticMetaObject = {
    { &GraphicsWidget::staticMetaObject, qt_meta_stringdata_GeneralWidget.data,
      qt_meta_data_GeneralWidget,  qt_static_metacall, nullptr, nullptr}
};
