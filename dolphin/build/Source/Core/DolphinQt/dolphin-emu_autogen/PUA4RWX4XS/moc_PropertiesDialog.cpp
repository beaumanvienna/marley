...
QT_MOC_LITERAL(1, 17, 19), // "OpenGeneralSettings"
QT_MOC_LITERAL(2, 37, 0) // ""

    },
    "PropertiesDialog\0OpenGeneralSettings\0"
    ""
};
...
void PropertiesDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PropertiesDialog::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PropertiesDialog::OpenGeneralSettings)) {
                *result = 0;
                return;
            }
        }
