/****************************************************************************
** Meta object code from reading C++ file 'WatchWidget.h'
**
...
#include "../../../../../../Source/Core/DolphinQt/Debugger/WatchWidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'WatchWidget.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 12, 23), // "RequestMemoryBreakpoint"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 3), // "u32"
QT_MOC_LITERAL(4, 41, 4) // "addr"

    },
    "WatchWidget\0RequestMemoryBreakpoint\0"
    "\0u32\0addr"
};
...
void WatchWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->RequestMemoryBreakpoint((*reinterpret_cast< u32(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (WatchWidget::*_t)(u32 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WatchWidget::RequestMemoryBreakpoint)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject WatchWidget::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_WatchWidget.data,
      qt_meta_data_WatchWidget,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void WatchWidget::RequestMemoryBreakpoint(u32 _t1)
{
