...
QT_MOC_LITERAL(3, 18, 6) // "serach"

    },
    "SearchBar\0Search\0\0serach"
};
...
void SearchBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SearchBar::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchBar::Search)) {
                *result = 0;
                return;
            }
        }
