...
PFN_PvkCreateBufferView PvkCreateBufferView;
PFN_PvkDestroyBufferView PvkDestroyBufferView;
...
PFN_PvkCreateImageView PvkCreateImageView;
PFN_PvkDestroyImageView PvkDestroyImageView;
...
PFN_PvkDestroyPipelineCache PvkDestroyPipelineCache;
...
PFN_PvkDestroyPipelineLayout PvkDestroyPipelineLayout;
...
PFN_PvkCmdDrawIndexed PvkCmdDrawIndexed;
...
PFN_PvkCmdCopyBufferToImage PvkCmdCopyBufferToImage;
PFN_PvkCmdCopyImageToBuffer PvkCmdCopyImageToBuffer;
...
PFN_PvkCmdDrawIndirect PvkCmdDrawIndirect;
PFN_PvkCmdDrawIndexedIndirect PvkCmdDrawIndexedIndirect;
PFN_PvkCmdDispatch PvkCmdDispatch;
PFN_PvkCmdDispatchIndirect PvkCmdDispatchIndirect;
...
PFN_PvkSetDebugUtilsObjectNameEXT     PvkSetDebugUtilsObjectNameEXT;
...
#define LOAD_INSTANCE_FUNC(instance, x) x = (PFN_ ## x)PvkGetInstanceProcAddr(instance, #x); if (!x) {INFO_LOG(G3D, "Missing (instance): %s", #x);}
#define LOAD_DEVICE_FUNC(instance, x) x = (PFN_ ## x)PvkGetDeviceProcAddr(instance, #x); if (!x) {INFO_LOG(G3D, "Missing (device): %s", #x);}
...
void VulkanLoadInstanceFunctions(VkInstance instance, const VulkanExtensions &enabledExtensions) {
	...
	if (enabledExtensions.EXT_debug_utils) {
		...
		LOAD_INSTANCE_FUNC(instance, PvkSetDebugUtilsObjectNameEXT);
...
void VulkanLoadDeviceFunctions(VkDevice device, const VulkanExtensions &enabledExtensions) {
	...
	LOAD_DEVICE_FUNC(device, PvkCreateBufferView);
	LOAD_DEVICE_FUNC(device, PvkDestroyBufferView);
	...
	LOAD_DEVICE_FUNC(device, PvkCreateImageView);
	LOAD_DEVICE_FUNC(device, PvkDestroyImageView);
	...
	LOAD_DEVICE_FUNC(device, PvkDestroyPipelineCache);
	...
	LOAD_DEVICE_FUNC(device, PvkDestroyPipelineLayout);
	...
	LOAD_DEVICE_FUNC(device, PvkCmdDrawIndexed);
	LOAD_DEVICE_FUNC(device, PvkCmdDrawIndirect);
	LOAD_DEVICE_FUNC(device, PvkCmdDrawIndexedIndirect);
	LOAD_DEVICE_FUNC(device, PvkCmdDispatch);
	LOAD_DEVICE_FUNC(device, PvkCmdDispatchIndirect);
	LOAD_DEVICE_FUNC(device, PvkCmdCopyBuffer);
	LOAD_DEVICE_FUNC(device, PvkCmdCopyImage);
	LOAD_DEVICE_FUNC(device, PvkCmdBlitImage);
	LOAD_DEVICE_FUNC(device, PvkCmdCopyBufferToImage);
	LOAD_DEVICE_FUNC(device, PvkCmdCopyImageToBuffer);
