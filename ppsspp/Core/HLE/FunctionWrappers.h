...
template<int func(int, int, const char*, u64)> void WrapI_IICU64() {
	int retval = func(PARAM(0), PARAM(1), Memory_P::GetCharPointer(PARAM(2)), PARAM64(4));
	RETURN(retval);
}
...
template<u32 func(int, void *, int)> void WrapU_IVI() {
	u32 retval = func(PARAM(0), Memory_P::GetPointer(PARAM(1)), PARAM(2));
	RETURN(retval);
}

template<int func(const char *, int, int, u32)> void WrapI_CIIU() {
	u32 retval = func(Memory_P::GetCharPointer(PARAM(0)), PARAM(1), PARAM(2), PARAM(3));
	RETURN(retval);
}

template<int func(int, const char *, u32, void *, void *, u32, int)> void WrapI_ICUVVUI() {
	u32 retval = func(PARAM(0), Memory_P::GetCharPointer(PARAM(1)), PARAM(2), Memory_P::GetPointer(PARAM(3)),Memory_P::GetPointer(PARAM(4)), PARAM(5), PARAM(6) );
	RETURN(retval);
}
...
template<int func(const char *, int, const char *, int, int, int, int, int)> void WrapI_CICIIIII() {
	u32 retval = func(Memory_P::GetCharPointer(PARAM(0)), PARAM(1), Memory_P::GetCharPointer(PARAM(2)),
...
template<int func(const char *, int, int, int, int, int, int)> void WrapI_CIIIIII() {
	u32 retval = func(Memory_P::GetCharPointer(PARAM(0)), PARAM(1), PARAM(2),
...
template<int func(int, int, int, int, int, int, int, int, u32)> void WrapI_IIIIIIIIU() {
	u32 param8 = *(u32*)Memory_P::GetPointer(currentMIPS->r[29]); //Fixed 9th parameter, thanks to Kingcom
...
template<u32 func(int, void *)> void WrapU_IV() {
	u32 retval = func(PARAM(0), Memory_P::GetPointer(PARAM(1)));
	RETURN(retval);
}
...
template<void func(u32, const char *)> void WrapV_UC() {
	func(PARAM(0), Memory_P::GetCharPointer(PARAM(1)));
}

template<int func(u32, const char *)> void WrapI_UC() {
	int retval = func(PARAM(0), Memory_P::GetCharPointer(PARAM(1)));
	RETURN(retval);
}

template<int func(u32, const char *, int)> void WrapI_UCI() {
	int retval = func(PARAM(0), Memory_P::GetCharPointer(PARAM(1)), PARAM(2));
	RETURN(retval);
}
...
template<int func(int, const char *, int, u32, u32)> void WrapI_ICIUU() {
	int retval = func(PARAM(0), Memory_P::GetCharPointer(PARAM(1)), PARAM(2), PARAM(3), PARAM(4));
	RETURN(retval);
}
...
template<u32 func(const char *)> void WrapU_C() {
	u32 retval = func(Memory_P::GetCharPointer(PARAM(0)));
	RETURN(retval);
}

template<u32 func(const char *, const char *, const char *, u32)> void WrapU_CCCU() {
	u32 retval = func(Memory_P::GetCharPointer(PARAM(0)),
			Memory_P::GetCharPointer(PARAM(1)), Memory_P::GetCharPointer(PARAM(2)),
			PARAM(3));
	RETURN(retval);
}

template<int func(const char *)> void WrapI_C() {
	int retval = func(Memory_P::GetCharPointer(PARAM(0)));
	RETURN(retval);
}

template<int func(const char *, u32)> void WrapI_CU() {
	int retval = func(Memory_P::GetCharPointer(PARAM(0)), PARAM(1));
	RETURN(retval);
}

template<int func(const char *, u32, int)> void WrapI_CUI() {
	int retval = func(Memory_P::GetCharPointer(PARAM(0)), PARAM(1), PARAM(2));
	RETURN(retval);
}

template<int func(int, const char *, int, u32)> void WrapI_ICIU() {
	int retval = func(PARAM(0), Memory_P::GetCharPointer(PARAM(1)), PARAM(2), PARAM(3));
	RETURN(retval);
}
...
template<int func(const char *, const char*, int, int)> void WrapI_CCII() {
	int retval = func(Memory_P::GetCharPointer(PARAM(0)), Memory_P::GetCharPointer(PARAM(1)), PARAM(2), PARAM(3));
	RETURN(retval);
}
...
template<u32 func(const char *, u32)> void WrapU_CU() {
	u32 retval = func(Memory_P::GetCharPointer(PARAM(0)), PARAM(1));
	RETURN((u32) retval);
}

template<u32 func(u32, const char *)> void WrapU_UC() {
	u32 retval = func(PARAM(0), Memory_P::GetCharPointer(PARAM(1)));
	RETURN(retval);
}
...
template<void func(const char *, u32, int, u32)> void WrapV_CUIU() {
	func(Memory_P::GetCharPointer(PARAM(0)), PARAM(1), PARAM(2), PARAM(3));
}

template<int func(const char *, u32, int, u32)> void WrapI_CUIU() {
	int retval = func(Memory_P::GetCharPointer(PARAM(0)), PARAM(1), PARAM(2), PARAM(3));
	RETURN(retval);
}

template<void func(u32, const char *, u32, int, u32)> void WrapV_UCUIU() {
	func(PARAM(0), Memory_P::GetCharPointer(PARAM(1)), PARAM(2), PARAM(3),
			PARAM(4));
}
...
template<u32 func(u32, const char *, u32, u32)> void WrapU_UCUU() {
	u32 retval = func(PARAM(0), Memory_P::GetCharPointer(PARAM(1)), PARAM(2), PARAM(3));
	RETURN(retval);
}
...
template<u32 func(const char *, const char *)> void WrapU_CC() {
	int retval = func(Memory_P::GetCharPointer(PARAM(0)),
			Memory_P::GetCharPointer(PARAM(1)));
	RETURN(retval);
}

template<void func(const char *, int)> void WrapV_CI() {
	func(Memory_P::GetCharPointer(PARAM(0)), PARAM(1));
}
...
template <int func(int, const char *, const char *, u32, int)> void WrapI_ICCUI() {
	int retval = func(PARAM(0), Memory_P::GetCharPointer(PARAM(1)), Memory_P::GetCharPointer(PARAM(2)), PARAM(3), PARAM(4));
	RETURN(retval);
}

template <int func(int, const char *, const char *, int)> void WrapI_ICCI() {
	int retval = func(PARAM(0), Memory_P::GetCharPointer(PARAM(1)), Memory_P::GetCharPointer(PARAM(2)), PARAM(3));
	RETURN(retval);
}
...
template<int func(int, void *, void *, void *, void *, u32, int)> void WrapI_IVVVVUI(){
  u32 retval = func(PARAM(0), Memory_P::GetPointer(PARAM(1)), Memory_P::GetPointer(PARAM(2)), Memory_P::GetPointer(PARAM(3)), Memory_P::GetPointer(PARAM(4)), PARAM(5), PARAM(6) );
  RETURN(retval);
}

template<int func(int, const char *, u32, void *, int, int, int)> void WrapI_ICUVIII(){
  u32 retval = func(PARAM(0), Memory_P::GetCharPointer(PARAM(1)), PARAM(2), Memory_P::GetPointer(PARAM(3)), PARAM(4), PARAM(5), PARAM(6));
  RETURN(retval);
}

template<int func(void *, u32, int)> void WrapI_VUI(){
	u32 retval = func(Memory_P::GetPointer(PARAM(0)), PARAM(1), PARAM(2));
	RETURN(retval);
}
